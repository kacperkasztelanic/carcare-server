...
@RestController
@RequestMapping("/api")
public class VehicleResourceOld {

    private final Logger log = LoggerFactory.getLogger(VehicleResourceOld.class);

    private static final String ENTITY_NAME = "vehicle";

    private VehicleRepository vehicleRepository;

    public VehicleResourceOld(VehicleRepository vehicleRepository) {
